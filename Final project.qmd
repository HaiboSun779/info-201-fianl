...
• What are the trends in TV shows and movies over the years? What might be contributing to this trend?
...
# Step 1: Specify the top 5 genres globally
top_5_genres <- c("International Movies", "Dramas", "Comedies", "International TV Shows", "Documentaries")

# Step 2: Filter data for the top 5 countries and the specified top 5 genres
...
# Step 3: Create interactive stacked bar chart
plot_ly(
  country_genre_data,
  x = ~country,
  y = ~count,
